...
export class Backend implements backendInterface {
    ...
    async addItem(arg0: ConsumptionItem): Promise<void> {
    ...
    async bulkImport(arg0: Array<ConsumptionItem>): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllItems(): Promise<Array<ConsumptionItem>> {
        if (this.processError) {
            try {
    ...
    async getItemsByDepartment(arg0: string): Promise<Array<ConsumptionItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getItemsByDepartment(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getItemsByMonthYear(arg0: number, arg1: number): Promise<Array<ConsumptionItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.getItemsByMonthYear(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getUniqueDepartments(): Promise<Array<string>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUniqueDepartments();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchItemsByCode(arg0: string): Promise<Array<ConsumptionItem>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchItemsByCode(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchItemsByName(arg0: string): Promise<Array<ConsumptionItem>> {
        if (this.processError) {
            try {
    ...
    async updateItemQuantity(arg0: string, arg1: string, arg2: number): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateItemQuantity(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
